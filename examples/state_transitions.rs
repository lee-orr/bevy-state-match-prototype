...
fn main() {
    App::new()
        ...
        .add_systems(
            Exiting,
            cleanup_ui.run_in(state_matches!(AppState, every _)),
        )
        ...
        .add_systems(
            Entering,
            paper_always_wins.run_in(|to: &AppState, from: &AppState| {
        ...
        .add_systems(
            Exiting,
            setup_scissors_to_paper.run_in(
                AppState::Scissors
        ...
        .add_systems(
            Exiting,
            setup_sciessors_or_rock_from_paper.run_in(
        ...
        .add_systems(
            Entering,
            setup_rocks_from_startup.run_in(
        ...
        .add_systems(Entering, last_choice_was_paper.run_in(AppState::Paper))
        .add_systems(Entering, last_choice_was_rock.run_in(AppState::Rock))
        .add_systems(
            Entering,
            last_choice_was_scissors.run_in(AppState::Scissors),
        )
